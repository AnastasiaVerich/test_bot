...
export const WITHDRAWAL_SCENE = {
    ...
    INVALID_AMOUNT: "Введена невалидная сумма.Она должна быть больше 0.05 и не меньше вашего баланса (доступно: {balance}).",
    INPUT_ADDRESS: "Вывод денег осуществляется в TON. Пришлите адрес вашего счета.\n" +
        "\n" +
    ...
    CONFIRMATION: "Подтвердите снятие <b>{amount}</b> на адрес: <b>{address}</b>.",

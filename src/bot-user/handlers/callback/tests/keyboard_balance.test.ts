...
// import { handleBalance } from "../keyboard_balance/keyboard_balance";
// import { BUTTONS_CALLBACK_QUERIES } from "../../../constants/button";
// import {checkBalance} from "../../../../database/queries/userQueries";
// import {HANDLER_KEYBOARD_BALANCE} from "../keyboard_balance/text";
//
...
//     expect(ctx.reply).toHaveBeenCalledWith(HANDLER_KEYBOARD_BALANCE.USER_ID_UNDEFINED);
//   });
//
...
//       `${HANDLER_KEYBOARD_BALANCE.BALANCE} 0!\n\n${HANDLER_KEYBOARD_BALANCE.BALANCE_HISTORY}\n`,
//     );
//   });
//
